...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("BodeBandidos");

        jLabel8.setText("Para mantenerse conectado con nosotros");

        jLabel7.setText("Inicie sesion con sus credenciales");
        ...
        btnCrear.setForeground(new java.awt.Color(255, 51, 51));
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (role == 2) {
            ...
            JOptionPane.showMessageDialog(this, "Inicio de sesión exitoso.");
            DashboardClient dp = new DashboardClient();
            dp.setVisible(true);
            dispose();
        }
